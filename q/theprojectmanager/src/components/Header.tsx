        ...
        <div className="flex h-16 items-center justify-between">
          ...
          {!isAuthenticated && (
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/" className="text-foreground hover:text-primary qandu-transition-all">Home</Link>
            </nav>
          )}
          ...
          <nav className="flex flex-col space-y-4">
            {isAuthenticated ? (
              <>
                ...
                <Link href="/settings" className="flex items-center space-x-2 text-foreground hover:text-primary py-2">
                ...
                <button 
                  ...
                  className="flex items-center space-x-2 text-red-500 hover:text-red-400 py-2 w-full text-left"
                >
              ...
              <>
                <div className="py-2 border-b border-border mb-2">
                  <button 
                    className="flex items-center justify-between w-full px-3 py-2 text-foreground hover:text-primary qandu-transition-all"
                  ...
                  {featuresDropdownOpen && (
                    <div className="mt-2 space-y-1 pl-4">
                      <Link 
                        href="/features" 
                        className="block px-3 py-2 text-sm text-foreground hover:text-primary qandu-transition-all"
