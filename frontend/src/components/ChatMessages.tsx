    ...
    <div className="flex-1 overflow-y-auto p-4">
      {messages.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-full text-center p-6">
          <h3 className="text-xl font-semibold mb-2">Welcome to Nexus Suite Chat</h3>
          <p className="text-muted-foreground mb-4">
            Start a conversation with our AI assistant powered by multiple language models
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-md">
            <div className="p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
              <p className="font-medium">"Tell me about your services"</p>
            </div>
            <div className="p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
              <p className="font-medium">"What pricing plans do you offer?"</p>
            </div>
            <div className="p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
              <p className="font-medium">"How does your system work?"</p>
            </div>
            <div className="p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
              <p className="font-medium">"I need help with implementation"</p>
            </div>
          </div>
        </div>
      ) : (
