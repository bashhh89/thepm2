...
const footerLinks = {
  ...
  solutions: [
    { label: 'AI Matching', href: '/solutions/ai-matching' },
    { label: 'Video Interviews', href: '/solutions/video-interviews' },
    { label: 'CRM', href: '/solutions/crm' },
    { label: 'Job Portal', href: '/solutions/job-portal' },
    { label: 'Chat Widget', href: '/solutions/chat-widget' },
    { label: 'Internal Chat', href: '/solutions/internal-chat' },
